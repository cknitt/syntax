...
and printStructureItem (si : Parsetree.structure_item) cmtTbl =
  ...
  | Pstr_attribute attr -> Doc.concat [Doc.text "@"; printAttribute attr cmtTbl]
...
and printSignatureItem (si : Parsetree.signature_item) cmtTbl =
  ...
  | Psig_attribute attr -> Doc.concat [Doc.text "@"; printAttribute attr cmtTbl]
         ...
         Doc.group
           (Doc.concat
              [
                ...
                formattedProps;
                (if isSelfClosing then Doc.concat [Doc.line; Doc.text "/>"]
                else Doc.nil);
              ]);
